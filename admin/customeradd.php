...
<input type="hidden" name="entryperson" value="<?php echo $_SESSION['user']['username'] ?>">
                                    ...
                                    <div class="panel-body">
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="cname" class="form-control"  placeholder="Enter Company Name" required="" id="cname">
   ...
   <span style="color:#f60000;    font-weight: bold;" id="errorMsg" class="dsNone error"></span>
        ...
        <span style="color:#f60000;    font-weight: bold;" id="successMsg" class="dsNone success">
                                                          ...
                                                          <span id="mobileno1val" style="color:#f60000;    font-weight: bold;"></span>
     ...
     <div class="col-sm-4">
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="jobtitle" name="jobtitle" class="form-control"  placeholder="Enter your Job / Title in Company" required>
                                                    </div>
...
<!-- PINCODE KA SEARCH KA CODE -->
                                                ...
                                                <div class="col-sm-4">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Suburb</label>     <span id="suburbval" style="color:#f60000; font-weight: bold;"></span>
