                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="number" name="mobileno1" class="form-control" placeholder="Enter your Mobile No [ Primary ] " value="<?php echo $row['mobileno1']; ?>" >
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div>
                                                                <input type="email" name="emailid1" class="form-control" placeholder="Enter your Email Id [ Primary ] " value="<?php echo $row['emailid1']; ?>" >
                                                                <span style="color:#009688;    font-weight: bold;"></span>
                                                            </div>
