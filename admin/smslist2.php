...
<div class='container'>
  <div class='filters'>
    ...
    <div class='filter-container col-md-3 '>
         ...
         <select  autocomplete='off' class='filter form-control' name='State' placeholder='State' data-col='State' class="form-control">
...
?>
  ...
  <div class='filter-container col-md-3'>
       ...
       <select  autocomplete='off' class='filter form-control' name='City' placeholder='City' data-col='City'>
...
<Br><br>
      <div class='filter-container col-md-3'>
        ...
        <select  autocomplete='off' class='filter form-control' name='Company Category' placeholder='Company Category' data-col='Company Category'>
...
?>
    ...
    <div class='filter-container col-md-3'>
          ...
          <select  autocomplete='off' class='filter form-control' name='Company Industries' placeholder='Company Industries' data-col='Company Industries'>
...
?>
     ...
     <div class='filter-container col-md-3'>
       ...
       <select autocomplete='off' class='filter form-control' name='Company Products' placeholder='Company Products' data-col='Company Products'>
...
?>
    ...
    <div class='filter-container col-md-3'>
          ...
          <select autocomplete='off' class='filter form-control' name='Company Exhibitions' placeholder='Company Exhibitions' data-col='Company Exhibitions'>
...
<Br><br>
    ...
    <div class='clearfix'></div>
                                                ...
                                                <form method="post" enctype="multipart/form-data" action="sms.php">
     ...
     <input class="btn btn-add" type="submit" name="update" value="Send Message" />
...
echo '                              <tr> 
  ...
  ';?>
       <td>
 <?php echo '   <input  type="checkbox" class="chkbox" value="'.$row['mobileno1'].'"/>
