...
?>
                 ...
                 <a href="customer.php">   <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3">
                     <div id="cardbox4">
                        <div class="statistic-box">
...
$result = mysqli_query($con,"select count(1) FROM vc");
$row = mysqli_fetch_array($result);
