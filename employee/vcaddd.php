...
$connect = mysqli_connect("localhost", "printnuk_soar", "soarprint@123", "printnuk_soarprint");
 ...
 $sql=mysqli_query($connect,"INSERT INTO vc (id,cname,mobileno1,emailid1,contactperson,department,jobtitle,mobileno2,landline,emailid2,pincode,state,country,city,suburb,addressline1,addressline2,landlineno1,landlineno2,
 fax,website,companyprofile,panno,gstno,companycategory,companyindustries,companyproducts,companyexhibitions,datee,entryperson) VALUES ('$id','$cname','$mobileno1',
 '$emailid1','$contactperson','$department','$jobtitle','$mobileno2','$landline','$emailid2','$pincode','$state','$country','$city','$suburb','$addressline1',
 '$addressline2','$landlineno1','$landlineno2','$fax','$website','$companyprofile','$panno','$gstno','$companycategory','$companyindustries','$companyproducts','$companyexhibitions','$datee','$entryperson'
)");
